...
ECHO "git clone -b REL_16_STABLE https://github.com/postgres/postgres.git "
sudo -u postgres bash -c 'git clone -b REL_16_STABLE https://github.com/postgres/postgres.git $HOME/code'
